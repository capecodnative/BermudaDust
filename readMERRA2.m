...
DustLatBATS=fLat;
DustLonBATS=fLon;
finalDustTableBATS=sortrows(finalDustTable,["Year" "Month" "Day"]);
finalDustTableBATS = removevars(finalDustTableBATS, ["DustSurf","DustSurf25","DustMass","DustMass25","BCMass","BCSurf","SO2Mass","SO2Surf","SO4Mass","SO4Surf","OCMass","OCSurf"]);
