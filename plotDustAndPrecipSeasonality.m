figure('position',[207, 369, 620 , 420]);
hAx1=gca;
...
hAx2=gca;
scatter(1:366,dustSurfMedianDayOfYearBATS,10,'r');
hold on;
hLine2=plot(1:366,movmean(dustSurfMedianDayOfYearBATS,[5,5]),'r');
